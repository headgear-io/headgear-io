...
rubik = {
    ...
    checkScrollForTransparentNavbar: debounce(function() {
        	if($(document).scrollTop() > 560 ) {
                if(transparent) {
                    ...
                    $('.logo-container img').attr('src', 'assets/img/HLOGO.PNG');
                }
            } else {
                if( !transparent ) {
                    transparent = true;
                    $('nav[role="navigation"]').addClass('navbar-transparent');
                    $('.logo-container img').attr('src', 'assets/img/IMG_0088.PNG');
                }
            }
    }, 17),
    ...
    initGoogleMaps: function(){
        var myLatlng = new google.maps.LatLng(53.5825717,9.9826476);
        //var centreLatlng = (53.543407,9.9910115);

        var mapOptions = {
          zoom: 13,
          center: new google.maps.LatLng(53.570746, 9.933641),
